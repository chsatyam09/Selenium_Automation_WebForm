...
public class Check_Functionality {
...
//            assertEquals(actualTitle, expectedTitle, "The page title doesn't match!");
         ...
         // Validate the current Title against the expected Title
            ...
            if (actualTitle.equals(expectedTitle)) {
                System.out.println("Test Passed: The page Title matches the expected Title.");
            	 ...
            	 System.out.println("Test Failed : The page Title  doesn't matches the expected Title.");
            }
         ...
         // Locate and interact with the readonly input element by XPath
            ...
            // Get the value of the readonly input (use .getAttribute("value") for input fields)
            String actualText = readText.getAttribute("value");

            // Check if the actual text matches the expected text
            if (expectedText.equals(actualText)) {
                System.out.println("Test Passed: The text in the readonly input matches the expected text.");
            } else {
                System.out.println("Test Failed: The text in the readonly input does not match the expected text.");
            }
